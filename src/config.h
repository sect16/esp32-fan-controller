...
#define MQTTCMNDMANUAL1            UNIQUE_DEVICE_NAME "/cmnd/MANUAL1"
#define MQTTSTATMANUAL1            UNIQUE_DEVICE_NAME "/stat/MANUAL1"
#define MQTTCMNDMANUAL2            UNIQUE_DEVICE_NAME "/cmnd/MANUAL2"
#define MQTTSTATMANUAL2            UNIQUE_DEVICE_NAME "/stat/MANUAL2"
...
#define HASSSENSORPWM1DISCOVERYPAYLOAD              HASSNAME "CPU Fan PWM" HASSUNIQUEID "_PWM1" HASSOBJECT "_PWM1" HASSICON "mdi:square-wave" HASSSTATE2 "value_json.pwm1" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "}"
#define HASSSENSORPWM2DISCOVERYPAYLOAD              HASSNAME "System Fan PWM" HASSUNIQUEID "_PWM2" HASSOBJECT "_PWM2" HASSICON "mdi:square-wave" HASSSTATE2 "value_json.pwm2" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "}"
#define HASSSENSORRPM1DISCOVERYPAYLOAD             HASSNAME "CPU Fan" HASSUNIQUEID "_RPM1" HASSOBJECT "_RPM1" HASSICON "mdi:fan" HASSSTATE2 "value_json.rpm0" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSRPMCLASS "}"
#define HASSSENSORRPM2DISCOVERYPAYLOAD             HASSNAME "System Fan" HASSUNIQUEID "_RPM2" HASSOBJECT "_RPM2" HASSICON "mdi:fan" HASSSTATE2 "value_json.rpm1" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSRPMCLASS "}"
...
#define HASSSENSORCOMPOSITEDISCOVERYTOPIC                "homeassistant/sensor/" UNIQUE_DEVICE_NAME "/nvme_Composite/config"
#define HASSSENSOR8169_2DISCOVERYTOPIC                "homeassistant/sensor/" UNIQUE_DEVICE_NAME "/r8169_0_300/config"
#define HASSSENSORTCTLDISCOVERYTOPIC                "homeassistant/sensor/" UNIQUE_DEVICE_NAME "/k10temp_Tctl/config"
...
#define HASSSENSOREDGEDISCOVERYTOPIC                "homeassistant/sensor/" UNIQUE_DEVICE_NAME "/amdgpu_edge/config"
#define HASSSENSORACPITZDISCOVERYPAYLOAD              HASSNAME "ACPITZ" HASSUNIQUEID "_acpitz" HASSOBJECT "_acpitz" HASSICON "mdi:thermometer" HASSSTATE1 "value_json.acpitz" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSTEMPCLASS "}"
...
#define HASSSENSORCOMPOSITEDISCOVERYPAYLOAD              HASSNAME "NVMe SSD" HASSUNIQUEID "_nvme_Composite" HASSOBJECT "_nvme_Composite" HASSICON "mdi:thermometer" HASSSTATE1 "value_json.nvme_Composite" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSTEMPCLASS "}"
...
#define HASSSENSORTCTLDISCOVERYPAYLOAD              HASSNAME "CPU" HASSUNIQUEID "_k10temp_Tctl" HASSOBJECT "_k10temp_Tctl" HASSICON "mdi:thermometer" HASSSTATE1 "value_json.k10temp_Tctl" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSTEMPCLASS "}"
...
#define HASSSENSOREDGEDISCOVERYPAYLOAD              HASSNAME "GPU" HASSUNIQUEID "_amdgpu_edge" HASSOBJECT "_amdgpu_edge" HASSICON "mdi:thermometer" HASSSTATE1 "value_json.amdgpu_edge" HASSSENSORCLASS "," HOMEASSISTANTDEVICE "," HASSTEMPCLASS "}"
...
#define HASSNUMBERPWMMANUAL1DISCOVERYPAYLOAD        HASSNAME "Manual PWM 1" HASSUNIQUEID "_pwmManual1" HASSOBJECT "_pwmManual1" HASSICON "mdi:square-wave" HASSSTAT "PWMMANUAL1" HASSCMND "PWMMANUAL1" "\"," HOMEASSISTANTDEVICE ",\"step\":1,\"min\":0,\"max\":256,\"mode\":\"slider\"}"
#define HASSNUMBERPWMMANUAL2DISCOVERYPAYLOAD        HASSNAME "Manual PWM 2" HASSUNIQUEID "_pwmManual2" HASSOBJECT "_pwmManual2" HASSICON "mdi:square-wave" HASSSTAT "PWMMANUAL2" HASSCMND "PWMMANUAL2" "\"," HOMEASSISTANTDEVICE ",\"step\":1,\"min\":0,\"max\":256,\"mode\":\"slider\"}"
#define HASSNUMBERPWMINIT1DISCOVERYTOPIC         "homeassistant/number/" UNIQUE_DEVICE_NAME "/pwmInit1/config"
#define HASSNUMBERPWMINIT1DISCOVERYPAYLOAD       HASSNAME "Default PWM 1" HASSUNIQUEID "_pwmInit1" HASSOBJECT "_pwmInit1" HASSICON "mdi:square-wave" HASSSTAT "PWMINIT1" HASSCMND "PWMINIT1" "\"," HOMEASSISTANTDEVICE ",\"step\":1,\"min\":0,\"max\":256,\"mode\":\"box\"}"
#define HASSNUMBERPWMINIT2DISCOVERYTOPIC         "homeassistant/number/" UNIQUE_DEVICE_NAME "/pwmInit2/config"
#define HASSNUMBERPWMINIT2DISCOVERYPAYLOAD       HASSNAME "Default PWM 2" HASSUNIQUEID "_pwmInit2" HASSOBJECT "_pwmInit2" HASSICON "mdi:square-wave" HASSSTAT "PWMINIT2" HASSCMND "PWMINIT2" "\"," HOMEASSISTANTDEVICE ",\"step\":1,\"min\":0,\"max\":256,\"mode\":\"box\"}"
...
#define HASSSWITCHMANUAL1DISCOVERYTOPIC             "homeassistant/switch/" UNIQUE_DEVICE_NAME "/manual1/config"
#define HASSSWITCHMANUAL1DISCOVERYPAYLOAD           HASSNAME "Manual Fan 1" HASSUNIQUEID "_manual1" HASSOBJECT "_manual1" HASSICON "mdi:toggle-switch" HASSSTAT "MANUAL1" HASSCMND "MANUAL1" "\"," HOMEASSISTANTDEVICE ",\"payload_on\":\"ON\",\"payload_off\":\"OFF\"}"
#define HASSSWITCHMANUAL2DISCOVERYTOPIC             "homeassistant/switch/" UNIQUE_DEVICE_NAME "/manual2/config"
#define HASSSWITCHMANUAL2DISCOVERYPAYLOAD           HASSNAME "Manual Fan 2" HASSUNIQUEID "_manual2" HASSOBJECT "_manual2" HASSICON "mdi:toggle-switch" HASSSTAT "MANUAL2" HASSCMND "MANUAL2" "\"," HOMEASSISTANTDEVICE ",\"payload_on\":\"ON\",\"payload_off\":\"OFF\"}"
